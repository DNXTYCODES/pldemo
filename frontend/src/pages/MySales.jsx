          ...
          images.map((img) =>
            img._id === imageId
              ? {
                  ...img,
                  priceEth: newPrice,
                  priceUsd: (parseFloat(newPrice) * currentEthPrice).toFixed(2),
                }
              : img,
          ),
        );
        ...
        <div>
          {loadingPending ? (
            ...
            <div className="mt-12 text-center py-16 bg-gray-800 rounded-lg border border-gray-700">
              ...
              <p className="text-gray-400 mb-8">All your uploads have been processed</p>
            </div>
          ) : (
                    ...
                    <div className="col-span-2">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        ...
                        <div>
                          ...
                          <span className="text-white">{image.priceEth} ETH</span>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <span className="text-amber-300 font-medium">
                            {image.gasFee} ETH (will be deducted upon approval)
                          </span>
                        </div>
                        <div className="col-span-2">

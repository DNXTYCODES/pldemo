  ...
  const slides = [
    {
      ...
      backgroundStyle: "linear-gradient(135deg, #1a1a1a 0%, #333 100%)",
    },
    {
      id: 1,
      href: "/shop",
      title: "Shop Prints",
      backgroundStyle: "linear-gradient(135deg, #2a2a2a 0%, #444 100%)",
    },
    {
      id: 2,
      href: "/about",
      title: "Get Inspired",
      backgroundStyle: "linear-gradient(135deg, #1a1a1a 0%, #555 100%)",
    },
  ];
        ...
        {slides.map((slide, index) => (
          <Link
            ...
            style={{
              ...
              background: slide.backgroundStyle,
              display: "flex",
              alignItems: "center",
